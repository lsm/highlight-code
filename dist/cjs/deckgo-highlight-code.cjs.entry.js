...
const index = require('./index-7839d2d4.js');
...
const DeckdeckgoHighlightCode = class {
    ...
    render() {
        return (index.h(index.Host, { class: {
            ...
            } }, this.renderCarbon(), this.renderUbuntu(), index.h("div", { class: "deckgo-highlight-code-container", onMouseDown: () => this.edit(), onTouchStart: () => this.edit() }, index.h("code", null), index.h("slot", { name: "code" }), index.h("slot", { name: "label" }))));
    }
    renderCarbon() {
        if (this.terminal !== 'carbon') {
            return undefined;
        }
        return (index.h("div", { class: "carbon" }, this.renderCarbonCircle('red'), this.renderCarbonCircle('yellow'), this.renderCarbonCircle('green')));
    }
